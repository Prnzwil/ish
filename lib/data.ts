...
export type ProcessStep = { t: string; d: string; num: string };
...
export type HoursRow = readonly [day: string, hours: string];
...
export const PRICING: readonly Pricing[] = [
  {
    label: "Essentials",
    name: "Signature",
...
export const GALLERY_CATS: readonly string[] = [
  "All",
  "Hairstyles",
  "Hair Coloring",
  "Bridal",
